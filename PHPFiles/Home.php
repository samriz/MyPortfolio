...
<body>
    ...
    <div id="homeintro" class="jumbotron">
        <h1>Sameer Rizvi</h1>
    </div>
    <h5 id="banner">*UNDER CONSTRUCTION*</h5>
    <hr>

    <div>
        <h6 style="text-decoration: underline;">Learn more about me by clicking on the icons below.</h6>
        <div id="extlinksdiv" class="">
        <p style="margin-left:5px;"><a href="https://www.linkedin.com/in/sameer-rizvi-bb788375" target="_blank">
        ...
        <a href="https://github.com/samriz" target="_blank">
